...
cd /etc/ocserv/
rm -rf ocserv.conf
wget --no-check-certificate https://raw.githubusercontent.com/forjustice/ocserv_chendong12_2209/master/ocserv.conf
#
cd /root/anyconnect
wget --no-check-certificate https://raw.githubusercontent.com/forjustice/ocserv_chendong12_2209/master/gen-client-cert.sh
wget --no-check-certificate https://raw.githubusercontent.com/forjustice/ocserv_chendong12_2209/master/user_add.sh
wget --no-check-certificate https://raw.githubusercontent.com/forjustice/ocserv_chendong12_2209/master/user_del.sh
